...
export const fetchNeo = async ({
  startDate,
  endDate,
}: NeoApiProps): Promise<Neo[]> => {
  const queryParams = `start_date=${startDate}&end_date=${endDate}&api_key=${API_KEY}`;
    ...
    estimated_diameter: {
      kilometers: {
        estimated_diameter_min:
          item.estimated_diameter.kilometers.esitmated_diameter_min,
        estimated_diameter_max:
          item.estimated_diameter.kilometers.esitmated_diameter_max,
      },
      meters: {
        estimated_diameter_min:
          item.estimated_diameter.meters.esitmated_diameter_min,
        estimated_diameter_max:
          item.estimated_diameter.meters.esitmated_diameter_max,
      },
    },
